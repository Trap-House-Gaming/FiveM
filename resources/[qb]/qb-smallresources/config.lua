...
Config.PauseMapText = 'Trap House'                                     -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
...
Config.Consumables = {
    eat = { -- default food items
        ...
        ['tbirria_taco'] = math.random(50, 50),
        ['thothoney_tenders'] = math.random(50, 50),
        ['tpizzaa_slice'] = math.random(50, 50),
        ['street_taco'] = math.random(50, 50),
        ['ttakis'] = math.random(50, 50),
        ['twings'] = math.random(50, 50),
        ['tmelon'] = math.random(50, 50),
        -- Casino Bar Snacks
        ["casino_burger"] = math.random(30, 40),
        ["casino_psqs"] = math.random(30, 40),
        ["casino_ego_chaser"] = math.random(30, 40),
        ["casino_sandwitch"] = math.random(30, 40),
        ["casino_donut"] = math.random(30, 40),
    },
    drink = { -- default drink items
        ['water_bottle'] = math.random(50, 50),
        ['kurkakola'] = math.random(50, 50),
        ['coffee'] = math.random(30, 30),
        ['tmexican_coke'] = math.random(50, 55),
        ['tpina_fanta'] = math.random(50, 50),
        ['tpink_lemon'] = math.random(50, 50),
        ['tfruit_punch'] = math.random(50, 50),
        -- Casino Bar Drinks
