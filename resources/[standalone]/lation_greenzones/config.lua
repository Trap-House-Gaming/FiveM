...
Config.GreenZones = { -- These are persistent greenzones that exist constantly, at all times - you can create as many as you want here
    ['hospital'] = {
        ...
        radius = 40.0, -- The radius (how large or small) the greenzone is (note: this must include the .0 on the end of the number to work)
        ...
        setSpeedLimit = 60, -- The speed limit (in MPH) that will be enforced in this zone if enableSpeedLimits is true
