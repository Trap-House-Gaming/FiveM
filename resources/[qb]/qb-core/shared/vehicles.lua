...
local Vehicles = {
    ...
    --- imports
    { model = 'rrgt500e',    name = 'GT500 E',                           brand = 'Mustang',        price = -0,  category = 'Import',      type = 'automobile', shop = 'none' },
	{ model = 'e46m3',    name = 'E46 M3',                           brand = 'BMW',        price = -0,  category = 'Import',      type = 'automobile', shop = 'none' },
	{ model = 'rmodmustang',    name = 'Roush',                           brand = 'Mustang',        price = -0,  category = 'Import',      type = 'automobile', shop = 'none' },
	{ model = 'brzdemonslayer',    name = 'Demon BRZ',                           brand = 'Subaru',        price = -0,  category = 'Import',      type = 'automobile', shop = 'none' },
	{ model = 'cateyelifted',    name = 'Cateye',                           brand = 'Cheverolet',        price = -0,  category = 'Import',      type = 'automobile', shop = 'none' },
