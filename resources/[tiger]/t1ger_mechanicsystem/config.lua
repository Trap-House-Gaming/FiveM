Config = {
	...
	ShopCreator = {
		...
		defaultDuty = false, -- set default duty on qb core jobs (doesnt matter for esx)
	...
	Markers = {
		['duty'] = {
			...
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Duty', icon = 'toggle-on', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
		...
		['boss'] = {
			...
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Boss Menu', icon = 'crown', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
		...
		['storage'] = {
			...
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Storage', icon = 'box', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
		...
		['workbench'] = {
			...
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Workbench', icon = 'toolbox', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
		...
		['repair'] = {
			...
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Repair', icon = 'screwdriver-wrench', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
