...
Config.Settings = {
    ...
    ["rodBrokeChanceWhenUpgrade"] = 10, -- WHAT IS THE CHANCE OF BREAKING THE FISHING ROD DURING LEVEL UPGRADING?
    ...
    ["tasksResetDay"] = 7, -- HOW MANY DAYS AFTER THE TASK IS RECEIVED WILL IT BE RESET (EVEN IF 1 TASK IS RECEIVED, ALL TASKS WILL BE DELETED AFTER THE WRITTEN DAY)
}

Config.Language = {
    ["eatBaitText"] = "You've lost your fish bait.",
    ["catchFish"] = "You caught something!",
