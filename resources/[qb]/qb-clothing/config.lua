...
Config.Stores = {
    ...
    [23] = {shopType = 'barber', coords = vector3(463.02, -998.88, 30.69), width = 2, length = 2}
}
...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(463.02, -998.88, 30.69), width = 2, length = 2, cameraLocation = vector4(454.42, -990.52, 30.69, 358.48)},
