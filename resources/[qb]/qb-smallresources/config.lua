...
Config.Consumables = {
    eat = { -- default food items
        ...
        ['tbirria_taco'] = math.random(2, 3),
        ['thothoney_tenders'] = math.random(2, 3),
        ['tpizzaa_slice'] = math.random(2, 3),
        ['street_taco'] = math.random(2, 3),
    ...
    drink = { -- default drink items
        ...
        ['coffee'] = math.random(1, 3),
        ['tmexican_coke'] = math.random(1, 3),
