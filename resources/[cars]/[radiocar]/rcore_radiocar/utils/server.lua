...
if Config.MysqlType ~= 0 then
    MysqlInit(function()
        CreateThread(function()
            MySQLSyncexecute([[ CREATE TABLE IF NOT EXISTS `radiocar_music`(`id` INT(11) NOT NULL AUTO_INCREMENT ,`label` VARCHAR(64) NOT NULL ,  `url` VARCHAR(256) NOT NULL ,`plate` VARCHAR(32) NOT NULL , PRIMARY KEY (`id`)); ]], {})

            MySQLSyncexecute([[CREATE TABLE IF NOT EXISTS `radiocar_owned`(`id` INT(11) NOT NULL AUTO_INCREMENT , `spz` VARCHAR(32) NOT NULL , `style` INT(11) NOT NULL ,PRIMARY KEY (`id`));]], {})
            ...
            MySQLSyncexecute([[CREATE TABLE IF NOT EXISTS `radiocar_playlist` (`id` INT(11) NOT NULL AUTO_INCREMENT ,`playlist` TEXT NOT NULL , `plate` VARCHAR(32) NOT NULL ,  PRIMARY KEY (`id`)); ]], {})
        end)
    end)
end
