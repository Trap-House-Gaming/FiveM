...
RegisterNetEvent('QBCore:onPlayerDeath')
AddEventHandler('QBCore:onPlayerDeath', function()
	deadPlayers[source] = true
end)

RegisterNetEvent('QBCore:onPlayerSpawn')
AddEventHandler('QBCore:onPlayerSpawn', function()
