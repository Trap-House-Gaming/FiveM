...
Blacklist = {
    --example:
    --"ac-m-0-3-2" --> Clothing with this specific name will not be displayed
    --"ac-m-0-3-2+" --> Textures higher than this will not be displayed
    --"ac-m-0-3-*" --> No texture will be displayed for this category
}
