        ...
        <div class="h-3/5 w-3/5 flex">
            <div class="w-96 py-6 px-8 flex flex-col gap-3 bg-[#0C1321] rounded-l-3xl">
                <div>
                    <h1 class="text-4xl text-white font-medium font-drunk">
                        {{ locale.workbench }} {{ locale.tier }} {{ $route.query.tier }}
                    </h1>
                    <p class="flex-1 text-sm text-white/20 font-light">
                        {{ locale.item_crafting }}
                    </p>
                </div>
            ...
            >
                <div class="flex-1 flex gap-8">
                    <div class="flex-1 flex flex-col gap-8">
                        ...
                        <div class="flex flex-col gap-2">
                            <h1 class="text-lg text-white">{{ locale.item_need_crafting }}</h1>
                            <div class="flex flex-wrap gap-y-2 gap-x-4">
                                <div
                                    v-for="(item, index) in getSelectedItem.craftingCost"
                                    :key="index"
                                    class="flex"
                                >
                                    <div
                    ...
                    <div class="w-64 flex flex-col justify-between gap-8">
                        ...
                        <!-- <div class="py-4 px-5 flex items-center gap-5 bg-[#BB3D43]/20 rounded-md">
                ...
                <ConfirmButton
                    ...
                    :disabled="!getSelectedItem.craftable"
                />
            </div>
            <div
                v-else
